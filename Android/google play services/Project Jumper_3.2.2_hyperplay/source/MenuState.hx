...
//import fr.hyperfiction.playservices.LeaderboardMetas;
...
class MenuState extends FlxState 
{
	...
	private var buton_unlockachiev1:FlxButton;
	private var buton3:FlxButton;
	private var buton4:FlxButton;
	...
	override public function create():Void 
	{
		...
		buton1 = new FlxButton(0, 0, "achievements", onbuton1);
		add(buton1);
		buton_unlockachiev1 = new FlxButton(300, 50, "Unlock achiev 1", onbuton2);
		add(buton_unlockachiev1);
		buton3 = new FlxButton(200, 100, "leaderboards", onbuton3);
		add(buton3);
		buton4 = new FlxButton(500, 100, "submit score of 100", onbuton4);
		add(buton4);
	...
	private function onbuton2():Void {
		Achievements.unlockAchievement("CgkI7-TKroAaEAIQAQ");
	}
	private function onbuton3():Void {
		Leaderboards.openAll();
	}
	private function onbuton4():Void {
		Leaderboards.submitScore("CgkI7-TKroAaEAIQBg",100);
	}
