...
class MenuState extends FlxState 
{
	...
	override public function create():Void 
	{
		...
		buton1 = new FlxButton(0, 0, "Chartboost interst", onchartboostinter);
		add(buton1);
		buton2 = new FlxButton(200, 200, "Chartboost ma", onchartboostma);
		add(buton2);
	...
	private function onchartboostinter():Void {
		//HaxeChartboost.init("53479a52c26ee47bb5ebeebc","e2032567f5f89c353856b5e77b64e66c06045206");
		//HaxeChartboost.OpenIntersetial();
		#if (android || ios)
		//var showChartboost = JNI.createMemberMethod("com/paala/testhaxe/MainActivity", "showChartboost2", "(Lcom/paala/testhaxe/MainActivity)V");
		var showChartboost = JNI.createStaticMethod("com/paala/testhaxe/MainActivity", "showChartboost", "()V");
		//JNI.getInstance();
showChartboost();

#end
	}
	private function onchartboostma():Void {
		//HaxeChartboost.init("53479a52c26ee47bb5ebeebc","e2032567f5f89c353856b5e77b64e66c06045206");
		//HaxeChartboost.OpenIntersetial();
		#if (android || ios)
		//var showChartboost = JNI.createMemberMethod("com/paala/testhaxe/MainActivity", "showChartboost2", "(Lcom/paala/testhaxe/MainActivity)V");
		//var showChartboost = JNI.createStaticMethod("com/paala/testhaxe/MainActivity", "showMA", "()V");
		var showChartboost2 = JNI.createStaticMethod("com/paala/testhaxe/MainActivity", "showChartboost3", "()V");
